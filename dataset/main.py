...
from .dataloader import IAMDataset, MemoryDataset
from .train import predict, train, validate
...
def main_validate(use_local_model: bool = True):
    processor = load_processor()
    val_dataset = IAMDataset(paths.val_dir, processor)
